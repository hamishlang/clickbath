...
$('.options').toggle(function () {
  $('.setArea').slideDown(200); // noteCount = true;
}, function () {
  $('.setArea').slideUp(200);
  $('.notes').slideUp(100);
  $('.keys').slideUp(100); // setTrue(noteCount, 0)
});
$('.presets').toggle(function () {
  $('.presetsArea').slideDown(200); // noteCount = true;
}, function () {
  $('.presetsArea').slideUp(200); // $('.notes').slideUp(100);
  // $('.keys').slideUp(100)
  // setTrue(noteCount, 0)
});
...
$('.test').on("click", function () {
  console.log($("input[name='note']:checked").val(), $("input[name='key']:checked").val(), $("input[name='tone1']:checked").val(), $("input[name='tone2']:checked").val(), $("#waves").val(), $("#birds").val());
  $("#knob1").val(50);
});
...
const buildMessageRow = messageItem => {
  ...
  newMessageRow.querySelector('.load').addEventListener('click', async () => {
    ...
    $(`#${messageItem.Tone2}`).prop("checked", true); // renderList();
  });
