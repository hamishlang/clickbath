...
let Am = ['A', 'C', 'E', 'G'];
let Asm = ['A#', 'C#', 'F', 'G#'];
let Bm = ['B', 'D', 'F#', 'A']; // Channels for delays
...
let panner = new Tone.Panner(); // panner.pan.setValueAtTime(-1, 0.25);
...
async function setup() {
  ...
  delay2.connect(reverb2); // merge.connect(reverb)
...
const tapeguitar = new Tone.Sampler({
  urls: {
    C5: "tapeguitar3.mp3",
    C4: "tapeguitar2.mp3",
    C3: "tapeguitar1.mp3" // C3: "tapeguitar1.mp3",
...
const guitar = new Tone.Sampler({
  urls: {
    C5: "guitar3.mp3",
    C4: "guitar2.mp3",
    C3: "guitar1.mp3" // C3: "tapeguitar1.mp3",
...
synth2.volume.value = -13; // const reverb = new Tone.Reverb(10)
...
function popupMaker(target, targetPop) {
  ...
  $(target).click(function (e) {
    ...
    $(".popup").fadeIn(100).fadeOut(700); // $(".popup").fadeOut(700);
...
$('.keySettings').change(function () {
  ...
  let setKeyValue = $("input[name='key']:checked").val(); // let setMoodValue = $("input[name='mood']:checked").val();
...
function showPosition(position) {
  ...
  $('.weatherImage').empty();
  console.log("Latitude: " + position.coords.latitude + "Longitude: " + position.coords.longitude); // console.log(weatherKey)
