...
function () {
  ...
  return t.u = function () {
    ...
    ; n.length < 20;) for (var r = x(40), i = 0; i < r.length; ++i) // Only accept values that are [0, maxMultiple), this ensures they can
...
function _t(t, e) {
  ...
  for (var r = 0; r < t.filters.length; r++) if (i = t.filters[r], o = e.filters[r], i.op !== o.op || !i.field.isEqual(o.field) || !ot(i.value, o.value)) return !1;
...
function $n(t) {
  for (var e = "", n = 0; n < t.length; n++) e.length > 0 && (e = tr(e)), e = Zn(t.get(n), e);
...
var yr = function ( // Note: Previous schema versions included a field
...
function () {
  ...
  return t.from = function (e, n, r) {
    ...
    for (var i = on(), o = e.mutations, s = 0; s < o.length; s++) i = i.insert(o[s].key, r[s].version);
...
function () {
  ...
  t.prototype.be = function (t, e) {
    ...
    return Ni(t).qt({
      ...
      for (var s = H.fromSegments(t); o && H.comparator(o, s) < 0;) n(o, null), o = i.getNext();
      ...
      return (0, _tslib.__generator)(this, function (o) {
        switch (o.label) {
          ...
          case 1:
            ...
            if (t = o.sent(), this.Je) for (e = 0, n = t; e < n.length; e++) r = n[e], this.Je.removeItem(this.fn(r.clientId));
            o.label = 2;
...
function () {
  ...
  t.prototype.getDocumentsMatchingQuery = function (t, e, n) {
    ...
    */
    ...
    for (var r = un(), i = 0, o = e; i < o.length; i++) for (var s = 0, u = o[i].mutations; s < u.length; s++) {
      var a = u[s];
...
function to(t, e, n, r) {
  return (0, _tslib.__awaiter)(this, void 0, void 0, function () {
    ...
    return (0, _tslib.__generator)(this, function (p) {
      switch (p.label) {
        case 0:
          for (i = C(t), o = un(), s = Ze(), u = on(), a = 0, c = n; a < c.length; a++) h = c[a], f = e.Gn(h.metadata.name), h.document && (o = o.add(f)), s = s.insert(f, e.zn(h)), u = u.insert(f, e.Hn(h.metadata.readTime));
...
function () {
  ...
  return t.$s = function (e, n) {
    for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = cn(), s = 0; i && s < r.activeTargetIds.length; ++s) i = B(r.activeTargetIds[s]), o = o.add(r.activeTargetIds[s]);
...
function () {
  ...
  return t.$s = function (e) {
    var n = JSON.parse(e);
    return "object" == typeof n && -1 !== ["Unknown", "Online", "Offline"].indexOf(n.onlineState) && "string" == typeof n.clientId ? new t(n.clientId, n.onlineState) : (S("SharedClientState", "Failed to parse online state: " + e), null);
  }, t;
}(),
    Io =
/** @class */
    ...
    return (0, _tslib.__awaiter)(this, void 0, void 0, function () {
      ...
      return (0, _tslib.__generator)(this, function (l) {
        switch (l.label) {
          ...
          case 1:
            for (t = l.sent(), e = 0, n = t; e < n.length; e++) (r = n[e]) !== this.Ms && (i = this.getItem(po(this.persistenceKey, r))) && (o = wo.$s(r, i)) && (this.qs = this.qs.insert(o.clientId, o));

            for (this.Js(), (s = this.storage.getItem(this.zs)) && (u = this.Ys(s)) && this.Xs(u), a = 0, c = this.Us; a < c.length; a++) h = c[a], this.Bs(h);
...
function is(t) {
  return (0, _tslib.__awaiter)(this, void 0, void 0, function () {
    ...
    return (0, _tslib.__generator)(this, function (o) {
      ...
      for (e = cs(t), n = 0, r = t.qr; n < r.length; n++) i = r[n], e.vr(i.mutations);
            ...
            return (0, _tslib.__awaiter)(this, void 0, void 0, function () {
              ...
              return (0, _tslib.__generator)(this, function (f) {
                switch (f.label) {
                  ...
                  case 4:
                    for (i = 0, o = e; i < o.length; i++) s = o[i], u = s.targetId, s.fromCache || (a = n.Bn.get(u), c = a.snapshotVersion, h = a.withLastLimboFreeSnapshotVersion(c), // Advance the last limbo free snapshot version
            ...
            return r = function (t, e, n, r, i) {
              var o = new vu({
                next: function (n) {
                  ...
                  e.enqueueAndForget(function () {
                    return gs(t, s);
                  }), n.fromCache && "server" === r.source ? i.reject(new G(j.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
                },
                error: function (t) {
                  return i.reject(t);
                }
    ...
    this._settings = new Hu(t), void 0 !== t.credentials && (this._credentials = function (t) {
      ...
      switch (t.type) {
        case "gapi":
          ...
          return k(!("object" != typeof e || null === e || !e.auth || !e.auth.getAuthHeaderValueForFirstParty)), new Vu(e, t.sessionIndex || "0");
...
function () {
  ...
  function t() {
    ...
    for (var n = 0; n < t.length; ++n) if (0 === t[n].length) throw new G(j.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
...
function La(t, e, n, r, i, o) {
  ...
  for (var c = 0; c < o.length; c += 2) u.push(qa(e, o[c])), a.push(o[c + 1]); // We iterate in reverse order to pick the last value for a field if the
  // user specified the field multiple times.


  for (var h = [], f = new ue(), l = u.length - 1; l >= 0; --l) if (!ja(h, u[l])) {
    var d = u[l],
...
function Ma(t) {
  return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof tt || t instanceof va || t instanceof pa || t instanceof Xu || t instanceof ya);
}
  ...
  return function (t, e, n, r, i, o) {
    ...
    for (var u = [], a = 0; a < i.length; a++) {
      ...
      if (s[a].field.isKeyField()) {
        if ("string" != typeof c) throw new G(j.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
...
function mc(t) {
  ...
  var s = {
    includeMetadataChanges: !1
      ...
      u = 0;
  "object" != typeof i[u] || oa(i[u]) || (s = i[u], u++);
  var a,
      c,
      h,
      f = {
              ...
              switch (n.label) {
                case 0:
                  return e = function (t, e) {
                    C(t).Zr.add(e), // Immediately fire an initial event, indicating all existing listeners
                    // are in-sync.
                    e.next();
                  }, [4
                  /*yield*/
                    ...
                    return (0, _tslib.__awaiter)(this, void 0, void 0, function () {
                      ...
                      return (0, _tslib.__generator)(this, function (o) {
                        switch (o.label) {
                          ...
                          case 1:
                            return (i = o.sent()) instanceof gt ? n.resolve(i) : i instanceof wt ? n.resolve(null) : n.reject(new G(j.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), [3
                            /*break*/
                            , 3];

                          case 2:
                            return r = o.sent(), i = fs(r, "Failed to get document '" + e + " from cache"), n.reject(i), [3
                            /*break*/
                            , 3];
...
function Rc(t) {
  for (var e = 0, n = t; e < n.length; e++) {
    var r = n[e];
    if ("object" == typeof r && !oa(r)) return r;
  }
                    ...
                    return (0, _tslib.__awaiter)(this, void 0, void 0, function () {
                      ...
                      return (0, _tslib.__generator)(this, function (a) {
                        switch (a.label) {
                          ...
                          case 2:
                            return s = a.sent(), u = fs(s, "Failed to execute query '" + e + " against cache"), n.reject(u), [3
                            /*break*/
                            , 3];
...
exports.weatherKey = exports.firebaseKeys = void 0;
const firebaseKeys = {
  apiKey: "AIzaSyDudd83m2A_UvfQYbcPZNoZtMLicJq2-KY",
  authDomain: "test-firebase-f871f.firebaseapp.com",
  projectId: "test-firebase-f871f",
  storageBucket: "test-firebase-f871f.appspot.com",
  messagingSenderId: "390928757622",
  appId: "G-Y7N5JR9HT6"
};
...
exports.weatherCaller = weatherCaller;
exports.messages = exports.weatherCall = void 0;
...
const weatherCall = _keys.weatherKey;
...
// CLICK BATH
$(".areaShow").hide();
$(".popUpMenu").hide(); //set the tempo for tone js

Tone.Transport.bpm.value = 120; // this took so bloody long to get right. Basically these are different chords, for different scales in both major and minor
...
let Am = ['A', 'C', 'E', 'G'];
let Asm = ['A#', 'C#', 'F', 'G#'];
let Bm = ['B', 'D', 'F#', 'A']; // Channels for delays, these are used later to establish the delay on the sound
...
let pannerTwo = new Tone.Panner(); // Load the reverb
...
async function setup() {
  ...
  await reverb2.generate(); // AUUUUDDDIOOOOO ROUTING
...
synth2.volume.value = -13; //this function is used to establish what notes to use, basically it checks the current checkmark boxes to find out what notes should be played by using if statements

let noteArray = octave => {
  // defaults to c major, same as check marks
  let notes = C; //re-establish the delay level as some other funcitions kill it so that note clashes do not occur

  delay.feedback.value = 0.8;
  delay2.feedback.value = 0.8; // here are a;; teh checkmarks
...
setup(); //defining the actual areas as buttons for ease of use

const audioButton = $("#audio-button");
const audioButton2 = $("#audio-button2"); // THIS IS THE ACTUAL CLICKER FUNCTION THAT MAKES NOISE
...
function synthSetup(theButton, panName, targetTwo, number) {
  ...
  theButton.on('click', e => {
    ...
    if ($(`#piano${number}`).is(':checked')) {
      synthName = piano1; // console.log(this)
    ...
    let y = e.clientY - rect.top; //Convert new number into -1 - 1 range to work with Pan numbering

    let xPanWidth = Math.floor(x) / rect.width * 2 - 1; //Convert number to format for actaves
    ...
    $(targetTwo).css('background', 'radial-gradient(at ' + gradientPercX + '% ' + gradientPercY + '%, rgba(255, 255, 255, 0.5)0%, rgba(101,141,210,0.0) 41%)');
...
synthSetup(audioButton2, pannerTwo, ".areaShow2", 2); // this is the UI for the circles that appear when you click somewhere
...
popupMaker(".area2", ".areaShow2"); // set up all of the effect loops
...
let wind = new Tone.Player("assets/wind.mp3").toDestination(); //setup the knob functionality, I'm using a frameworks to support this as I really wanted a knob instead of a slider, which would have been easier, but not as fun to use
...
function knobFunction(target, parent, toneName) {
  ...
  document.getElementById(target).addEventListener("input", event => {
    let knobAdjust = 255 - event.target.value * 2.55; // took a while to get my head around how to translate the 1-100 values to DB values
    ...
    if (event.target.value === 0) {
      toneName.volume.value = -100;
      toneName.mute = true; // toneName.stop()
...
knobFunction("wind", ".knob-container8", wind); //establish the nexus oscillators, which is the thing making the sound visualisation
...
oscilloscope2.connect(merge2); //CURSOR FUNCTIONS
...
cursorForBoxes(area2, cursor2); //this was really important for me to get right, and took quiet a bit of time. Basically this functions ensures that when some dropdowsn are activated, others are closed
...
keyDisplay('.selectedMood', '.moods'); //this is the menu display, did a combo function for all menus as I needed the top one to be able to close the additional drop downs within it, the bottom one doesn't need this hence the if statements
...
menuDisplay('.presets', '.presetsArea'); //if there is change in the key activate it, also, if one is selected of the musical keys and the other isn't, select a note or key by default to ensure a key is selected

$('.keySettings').change(function () {
  showWeatherNotActive(); // auto populate DIV with note when changed 
...
$('.notes').change(function () {
  ...
  $("input[name='mood']:checked").removeAttr('checked'); //check if a key has been selected, if not, select major by default
...
function thingsChange(target, gradientMask, number) {
  $(target).change(function (e) {
    gradientChanger(gradientMask, number); // gradientChanger(gradientMask, number)
...
thingsChange('.set2', ".gradient2", 2); // if the key changes, make sure to change the delay and slide up the actual selection to lower the amount of user clicks needed
...
$('.keys').change(function () {
  ...
  $('.keys').slideUp(100);
  $('.actualKey').text(setKeyValue);
  setDaKey(); //check if a key has been selected, if not, select major by default
...
const buildMessageRow = messageItem => {
  ...
  newMessageRow.querySelector('.load').addEventListener('click', async () => {
    ...
    notification(`${messageItem.Name} loaded`); // renderList();
  });
...
const onLoadHandler = async () => {
  ...
  await renderList(); // So good putting the gradient changes here, means the browser gently loads in the shades once finished looading 
  ...
  document.getElementById('submit').addEventListener('click', async evt => {
    ...
    await database.messages.create(newMessageInput.value); // await database.Tone1.create($("input[name='tone1']:checked").val());
...
const getWeather = function (lat, lon) {
  ...
  fetch(url).then(response => {
    ...
    $('.weatherImage').append(`<img class="actualWeatherImage"src="http://openweathermap.org/img/wn/${json.current.weather[0].icon}@2x.png" alt="">`);
  }).catch(error => {
